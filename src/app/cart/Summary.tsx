                ...
                <div className="wrapper space-y-[37px] mx-auto">
                    ...
                    <div className="space-y-[18px]">
                        ...
                        <button
                            ...
                            className="w-full text-white  hover:bg-[#CED7F4]  bg-secondary-darkBlue text-center p-[10px] rounded-[5px]"
                        >
                            Checkout
                        </button>
                        <button
                            onClick={() => push("/#shop")}
                            className="w-full text-secondary-darkBlue hover:text-[#CED7F4] hover:border-[#CED7F4]  font-semibold  border   border-secondary-darkBlue text-center p-[10px] rounded-[5px]"
                        >
                            Continue Shopping
                        </button>
                    </div>
