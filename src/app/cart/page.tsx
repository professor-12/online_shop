...
const Cart = () => {
    return (
        <div className="bg-[#E8EBF8] px-3">
            <div className="md:py-12 py-6  wrapper mx-auto space-y-[30px] min-h-screen">
                ...
                <div className="flex max-md:flex-col space-y-[39px] md:space-y-0 md:space-x-[118px]">
