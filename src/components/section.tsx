        ...
        <div className="bg-black py-[10px] text-white my-[66px]">
            <div className="mx-auto p-10 md:w-[80%] lg:w-[70%] flex-col lg:flex-row gap-[54px] flex items-center justify-between">
                <div className="space-y-[39px]">
                    <h1 className="md:text-4xl xl:text-[36px] text-2xl max-md:text-center md:leading-[48px] font-semibold text-nowrap">
                        Sustainable Footwear for <br className="max-md:hdden" />{" "}
                        Every Step
                    </h1>
                    <button className="text-black max-md:px-2  p-[8px] bg-white rounded-[20px]  flex justify-between max-md:mx-auto items-center">
