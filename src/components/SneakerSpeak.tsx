...
const SneakerSpeak = () => {
    ...
    return (
        <div className="overflow-x-hidden mx-auto xl:w-[88%] space-y-[29px] mb-[66px]">
            <h1 className="text-[20px] md:text-[36px] font-semibold text-center">
                Sneaker Speak
            </h1>
            <div
                style={{ transform: `translateX(-${position}px)` }}
                className="grid max-l:hidden transition-all duration-500  max-lg:pl-6  xl:px-12 w-full place-items-center gap-[28px] grid-flow-col"
            >
                {List.map((e, indx) => (
                    <div
                        key={indx}
